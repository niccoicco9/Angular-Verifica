...
var TabsPage = /** @class */ (function () {
    ...
    TabsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"c:\Users\Carlo\Desktop\verificafinale\Angular-Verifica\app\src\pages\tabs\tabs.html"*/'<ion-tabs>\n\n  <ion-tab [root]="tab1Root" tabTitle="Items" tabIcon="md-clipboard"></ion-tab>\n\n  \n\n</ion-tabs>\n\n'/*ion-inline-end:"c:\Users\Carlo\Desktop\verificafinale\Angular-Verifica\app\src\pages\tabs\tabs.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_native_storage__ = __webpack_require__(155);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ionic_native_camera__ = __webpack_require__(275);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__providers_oggettiprovider_oggettiprovider__ = __webpack_require__(79);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_11__providers_oggettiprovider_oggettiprovider__["a" /* ProviderServizio */],
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"c:\Users\Carlo\Desktop\verificafinale\Angular-Verifica\app\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n\n'/*ion-inline-end:"c:\Users\Carlo\Desktop\verificafinale\Angular-Verifica\app\src\app\app.html"*/
        }),
...
var HomePage = /** @class */ (function () {
    function HomePage(nativeStorage, prestitoProvider, navCtrl) {
        var _this = this;
        this.nativeStorage = nativeStorage;
        this.prestitoProvider = prestitoProvider;
        this.navCtrl = navCtrl;
        this.prestiti = [];
        this.prestitoProvider.getdelloggetto().subscribe(function (prestiti) { return _this.prestiti = prestiti; });
    }
    HomePage.prototype.modificaItem = function (prestito) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_2__pages_interactionpage_interactionpage__["a" /* ModicaAggiungi */], { selector: 'modifica', prestito: prestito });
    };
    HomePage.prototype.aggiungi = function () {
    ...
    HomePage.prototype.rimuovi = function (prestito) {
        this.prestitoProvider.rimuovi(prestito.id);
    };
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"c:\Users\Carlo\Desktop\verificafinale\Angular-Verifica\app\src\pages\home\home.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <ion-buttons start>\n\n      <button (click)="aggiungi()" ion-button icon-only>\n\n        <ion-icon name="add-circle-outline"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n    <ion-title>Home</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n  <h2>Prestiti</h2>\n\n  <ion-list>\n\n    <ion-item-sliding #item *ngFor="let prestito of prestiti">\n\n\n\n\n\n        <ion-item color="{{prestito.restituito ? \'secondary\' : \'danger\'}}">\n\n          <ion-avatar item-start>\n\n            <img src="jonny.png">\n\n          </ion-avatar>\n\n         \n\n            \n\n            <h2>{{prestito.nome}}</h2>\n\n            \n\n            <p class="data">{{prestito.persona}} -  data {{prestito.data | date: \'dd/MM/yy\'}}</p>\n\n       \n\n          \n\n\n\n        </ion-item>\n\n         \n\n        \n\n    \n\n        \n\n          \n\n\n\n          <ion-item-options side="right">\n\n            <button ion-button (click)="modificaItem(prestito)" color="default" >Modifica</button>\n\n            <button ion-button (click)="rimuovi(prestito)"  color="danger" >Elimina</button>\n\n\n\n          </ion-item-options>\n\n    </ion-item-sliding>\n\n  </ion-list>\n\n</ion-content>'/*ion-inline-end:"c:\Users\Carlo\Desktop\verificafinale\Angular-Verifica\app\src\pages\home\home.html"*/
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_4__ionic_native_native_storage__["a" /* NativeStorage */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__ionic_native_native_storage__["a" /* NativeStorage */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__providers_oggettiprovider_oggettiprovider__["a" /* ProviderServizio */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__providers_oggettiprovider_oggettiprovider__["a" /* ProviderServizio */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */]) === "function" && _c || Object])
    ], HomePage);
    return HomePage;
    var _a, _b, _c;
}());
...
var ProviderServizio = /** @class */ (function () {
    ...
    ProviderServizio.prototype.aggiungi = function (prestito) {
        this.prestiti.push(prestito);
    };
    ProviderServizio.prototype.rimuovi = function (id) {
        var _this = this;
